...
public class MailManager {
    ...
    private static final String SENDER_NAME = "13124757783@163.com";
    private static final String SENDER_PASS = "wwwww";
    ...
    private static final String RECEIVER_NAME = "2474015897@qq.com";
    ...
    private MimeMessage createMessage(String title, String content) {
        ...
        try {
            ...
            InternetAddress[] addresses = new InternetAddress[]{new InternetAddress(RECEIVER_NAME)};
