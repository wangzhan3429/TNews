...
public class News implements Parcelable {
    ...
    public   int is_Connect = 0; // 默认是false

    public News(String id,String desc, String url, String author, String time, String timestemp, int
            is_Connect) {
        this.id = id;
        this.desc = desc;
        this.url = url;
...
//    }
    ...
    public News updateTimeStemp(String timestemp) {
        return new News(this.id,this.desc, this.url, this.author, this.time, timestemp,this
                .is_Connect);
    }
}
